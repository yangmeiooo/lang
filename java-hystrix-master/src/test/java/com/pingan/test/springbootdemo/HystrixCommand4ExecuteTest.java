...
//		System.out.println("mainthread:" + Thread.currentThread().getName());
		HelloWorldHystrixCommand helloWorldHystrixCommand = new HelloWorldHystrixCommand("Hlx");

		String executeResult = helloWorldHystrixCommand.execute();
		//executeResult = helloWorldHystrixCommand.execute();
